          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <button
                  className={`flex items-center justify-center p-4 rounded-md ${aspectRatio === 16 / 9 ? "bg-blue-600" : "bg-gray-800"
                    } text-lg`}
                ...
                <button
                  className={`flex items-center justify-center p-4 rounded-md ${aspectRatio === 9 / 16 ? "bg-blue-600" : "bg-gray-800"
                    } text-lg`}
                ...
                <button
                  className={`flex items-center justify-center p-4 rounded-md ${aspectRatio === 21 / 9 ? "bg-blue-600" : "bg-gray-800"
                    } text-lg`}
                ...
                <button
                  className={`flex items-center justify-center p-4 rounded-md ${aspectRatio === 9 / 21 ? "bg-blue-600" : "bg-gray-800"
                    } text-lg`}
